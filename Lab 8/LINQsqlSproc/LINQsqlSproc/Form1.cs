...
namespace LINQsqlSproc
{
    public partial class Form1 : Form
    {
        ...
        {
            string param = textBox2.Text; var custquery = db.CustOrderHist(param);
            string msg = "";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string msg = ""; foreach (CustOrdersDetailResult custOrdersDetail in custquery)
            { msg = msg + custOrdersDetail.ProductName + "\n"; }
            if (msg == "") msg = "No results."; MessageBox.Show(msg);
            param = ""; textBox1.Text = "";
        }
    }
}
